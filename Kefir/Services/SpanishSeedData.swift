...
struct SpanishSeedData {
    ...
    static let decks: [(String, String, [(String, String, String)])] = [
        ("ES — Алфавит", "Все буквы: название, звук, пример", alphabetFull),
        ("ES — Алфавит и звуки", "Правила чтения: особые буквы и сочетания", alphabet),
        ("ES — Фразы с нуля", "Самые простые фразы для начинающих", survival),
        ("ES — Базовые фразы", "Приветствия, вежливость", phrases),
        ("ES — Повседневные фразы", "Частые фразы на каждый день", everyday),
    ...
    static let alphabetFull: [(String, String, String)] = [
        ("A a", "название «a», звук [а]", "agua — вода"),
        ("B b", "название «be», звук [б]", "bueno — хороший"),
        ("C c", "название «ce», звук [с] / [к]", "casa — дом"),
        ("D d", "название «de», звук [д]", "día — день"),
        ("E e", "название «e», звук [э]", "ella — она"),
        ("F f", "название «efe», звук [ф]", "flor — цветок"),
        ("G g", "название «ge», звук [г] / [х]", "gato — кот"),
        ("H h", "название «hache», не читается", "hola — привет"),
        ("I i", "название «i», звук [и]", "isla — остров"),
        ("J j", "название «jota», звук [х]", "jamón — ветчина"),
        ("K k", "название «ka», звук [к]", "kilo — кило"),
        ("L l", "название «ele», звук [л]", "luna — луна"),
        ("M m", "название «eme», звук [м]", "madre — мать"),
        ("N n", "название «ene», звук [н]", "noche — ночь"),
        ("Ñ ñ", "название «eñe», звук [нь]", "niño — ребёнок"),
        ("O o", "название «o», звук [о]", "oso — медведь"),
        ("P p", "название «pe», звук [п]", "pan — хлеб"),
        ("Q q", "название «cu», звук [к]", "queso — сыр"),
        ("R r", "название «erre», звук [р]", "rojo — красный"),
        ("S s", "название «ese», звук [с]", "sol — солнце"),
        ("T t", "название «te», звук [т]", "todo — всё"),
        ("U u", "название «u», звук [у]", "uva — виноград"),
        ("V v", "название «uve», звук [б]", "vida — жизнь"),
        ("W w", "название «uve doble», звук [в]/[у] (заимств.)", "wifi — вайфай"),
        ("X x", "название «equis», звук [кс]", "taxi — такси"),
        ("Y y", "название «ye», звук [й] / [и]", "yo — я"),
        ("Z z", "название «zeta», звук [с]", "zapato — ботинок")
    ]

    static let everyday: [(String, String, String)] = [
        ("¿Cómo estás?", "как ты / как дела?", "кóмо эстáс"),
        ("Estoy bien, ¿y tú?", "хорошо, а ты?", "эстóй бьен и ту"),
        ("¿Qué es esto?", "что это?", "кэ эс э́сто"),
        ("Claro", "конечно", "клáро"),
        ("Creo que sí", "думаю, да", "крéо ке си"),
        ("Creo que no", "думаю, нет", "крéо ке но"),
        ("Vale", "ладно / ок", "бáле"),
        ("¡Vamos!", "пойдём!", "бáмос"),
        ("Espera", "подожди", "эспэ́ра"),
        ("Tengo hambre", "я голоден", "тэ́нго áмбре"),
        ("Tengo sed", "хочу пить", "тэ́нго сэд"),
        ("Estoy cansado", "я устал", "эстóй кансáдо"),
        ("¿Qué hora es?", "который час?", "кэ óра эс"),
        ("Hoy", "сегодня", "ой"),
        ("Mañana", "завтра", "маньяна"),
        ("Me gusta mucho", "мне очень нравится", "мэ гýста мýчо"),
        ("No pasa nada", "ничего страшного", "но пáса нáда"),
        ("No hay problema", "нет проблем", "но ай проблéма"),
        ("Por supuesto", "конечно", "пор супуэ́сто"),
        ("Más o menos", "так себе", "мас о мэ́нос"),
        ("Buena suerte", "удачи", "буэ́на суэ́рте"),
        ("Felicidades", "поздравляю", "фелисидáдес"),
        ("De acuerdo", "договорились / согласен", "де акуэ́рдо"),
        ("Puede ser", "может быть", "пуэ́де сэр")
    ]
    ...
    static let survival: [(String, String, String)] = [
        ("No hablo español", "я не говорю по-испански", "но áбло эспаньóль"),
        ("¿Habla inglés?", "вы говорите по-английски?", "áбла инглéс"),
        ("¿Habla ruso?", "говорите по-русски?", "áбла рýсо"),
        ("No entiendo", "я не понимаю", "но энтьéндо"),
        ("¿Puede repetir?", "можете повторить?", "пуэ́де рэпетúр"),
        ("Más despacio, por favor", "медленнее, пожалуйста", "мас деспáсио пор фавóр"),
        ("¿Cómo se dice...?", "как сказать...?", "кóмо се дúсе"),
        ("¿Qué significa?", "что это значит?", "кэ сигнифúка"),
        ("Quiero esto", "я хочу это", "кьéро э́сто"),
        ("Necesito ayuda", "мне нужна помощь", "несесúто айýда"),
        ("¿Puede ayudarme?", "можете мне помочь?", "пуэ́де айудáрме"),
        ("¿Dónde está el baño?", "где туалет?", "дóнде эстá эль бáньо"),
        ("¿Cuánto cuesta?", "сколько стоит?", "куáнто куэ́ста"),
        ("Estoy perdido", "я заблудился", "эстóй пердúдо"),
        ("No sé", "я не знаю", "но сэ"),
        ("Un momento", "одну минуту", "ун момэ́нто"),
        ("Con permiso", "извините (разрешите пройти)", "кон пермúсо"),
        ("Sí, por favor", "да, пожалуйста", "си пор фавóр"),
        ("No, gracias", "нет, спасибо", "но грáсиас"),
        ("¿Cómo te llamas?", "как тебя зовут?", "кóмо те йáмас"),
        ("Mucho gusto", "очень приятно", "мýчо гýсто"),
        ("Soy de Rusia", "я из России", "сой де рýсиа"),
        ("Agua, por favor", "воду, пожалуйста", "áгуа пор фавóр"),
        ("La cuenta, por favor", "счёт, пожалуйста", "ла куэ́нта пор фавóр"),
        ("Está bien", "хорошо / ладно", "эстá бьен")
    ]
